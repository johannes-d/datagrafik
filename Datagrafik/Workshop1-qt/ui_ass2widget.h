...
public:
    ...
    void retranslateUi(QWidget *Ass2Widget)
    {
        ...
        btn_parallel->setText(QApplication::translate("Ass2Widget", "Parallel", Q_NULLPTR));
        btn_perspective->setText(QApplication::translate("Ass2Widget", "Perspective", Q_NULLPTR));
